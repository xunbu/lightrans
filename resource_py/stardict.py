...
if __name__ == '__main__':
    ...
    # convert_dict('stardict.db','stardict.csv')
    a = StarDict(r"D:\pyfiles\autotrans\selectrans\dict.db", False)

    print(a.match('ching'))
    # query=a.query('differential')
    # print(f"{query['word']}  [{query['phonetic']}]\n标签:{query['tag']}\n{query['translation']}\n{query['definition']}")
